...
for (let index = 0; index < image.length; index++) {
    image[index].addEventListener('click',xxx);
}

function xxx(){
this.src = 'https://e7.pngegg.com/pngimages/628/1018/png-clipart-x-mark-symbol-computer-icons-w-miscellaneous-cross.png';
this.className = "x";
